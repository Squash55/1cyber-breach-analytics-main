...
def show_chart_quadrant(df):
    ...
    # === INTERPRETATIONS ===
    st.markdown("### 📈 Bubble Chart Interpretation")
    st.markdown("""
    This chart reveals how mission type and cyber risk level jointly affect breach patterns.  
    Each circle’s size shows sample count, and color reflects breach rate. Chi-Squared flags indicate statistically significant deviations.
    """)
